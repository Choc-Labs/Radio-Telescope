...
print
"The spectrometer (pre-amplification) should see", mrt.W2dBm((Wthermal1MHz * G_LNA).value), "dBm"
print
"The spectrometer (post-amplification) should see", mrt.W2dBm((Wthermal1MHz * G_tot).value), "dBm"
print
"The power detector should see", (Wthermal1MHz * G_tot * BW_N1MHz).value * 1e6, "microW"
print
"The power detector should see", mrt.W2dBm((Wthermal1MHz * G_tot * BW_N1MHz).value), "dBm"

# What's the dynamic range we expect to see?
print
print
"Atmosphere:", mrt.W2dBm((Pthermal(20. * u.K, 800. * u.MHz) * G_tot).value), "dBm"
print
"Room:", mrt.W2dBm((Pthermal(300. * u.K, 800. * u.MHz) * G_tot).value), "dBm"
print
"Sun:", mrt.W2dBm((Pthermal(5800. * np.power(0.5 / 4.5, 2) * u.K, 800. * u.MHz) * G_tot).value), "dBm"
